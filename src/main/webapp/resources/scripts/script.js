...
import { form, rContainer, rCheckboxes, svgArea, table, xContainer, xSelect, yContainer, yInput, } from "./variables.js";
...
const addDotToTheTable = (dotInfo) => {
    if (dotInfo == null) {
        return;
    }
    table.innerHTML += `
...
const sendAndAddDot = (x, y, r) => __awaiter(void 0, void 0, void 0, function* () {
    const dotInfo = yield sendDot(x, y, r);
...
form.addEventListener("submit", (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    markAll();
    yield sendAndAddDot(getX(), getY(), getR());
    form.reset();
}));
svgArea.addEventListener("click", (e) => __awaiter(void 0, void 0, void 0, function* () {
    if (!checkR()) {
        markR();
        return;
    }
